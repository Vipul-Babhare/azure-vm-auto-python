...
# MODEL_SERVING_URL = os.getenv('MODEL_SERVING_URL', 'http://141.147.118.28:8520')
...
#             status_code=503,
#             detail={
#                 "error": "Cannot connect to TensorFlow Serving",
#                 "tf_serving_url": tf_serving_url,
#                 "message": "Ensure TensorFlow Serving is running and accessible"
#             }
#         )
